 ...
 * @author donaldo
 */
public class SeleccionMetodo extends javax.swing.JInternalFrame {

    int idOrden;
    public SeleccionMetodo(int idOrden) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "L4L", "EOQ", "otro1", "otro2" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        switch(this.jComboBox1.getSelectedIndex()+1){
            case 1: {
                Calendario c = new Calendario(idOrden);
